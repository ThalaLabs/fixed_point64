...
module fixed_point64::fixed_point64 {
    ...
    public fun mul_u128(fp: FixedPoint64, y: u128): FixedPoint64 {
        // vm would direct abort when overflow occured
        let v = fp.v * y;
    ...
    public fun div_u128(fp: FixedPoint64, y: u128): FixedPoint64 {
        assert!(y != 0, ERR_DIVIDE_BY_ZERO);
    ...
    public fun mul_div_u128(fp: FixedPoint64, y: u128, z: u128): FixedPoint64 {
    ...
    public fun add_u128(fp: FixedPoint64, y: u128): FixedPoint64 {
        // vm would direct abort when overflow occured
    ...
    public fun sub_u128(fp: FixedPoint64, y: u128): FixedPoint64 {
        // vm would direct abort when underflow occured
        let v = ((fp.v as u256) - ((y as u256) << 64) as u128);
    ...
    /// Returns a `FixedPoint64` which represents the ratio of the numerator to the denominator.
    public fun fraction_u128(numerator: u128, denominator: u128): FixedPoint64 {
        assert!(denominator != 0, ERR_DIVIDE_BY_ZERO);
